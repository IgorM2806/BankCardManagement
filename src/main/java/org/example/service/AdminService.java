...
public class AdminService {
    ...
    public Users createUser(String name, String surname, String patronymic, RoleEnum role, String passwordHash) {
        passwordHash = "temp";
        ...
        Users user = new Users(name, surname, patronymic, role, passwordHash);
